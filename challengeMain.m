...
pathloc=genpath(pwd, '.git', 'models', 'data', 'results');
addpath(pathloc)
...
scoringMethods = {@randomScore, @computeGTE @BhaGany}; % Other methods include: @computeIGGini, @computeIGEntropy, @computeCrossCorrelation, @computeGranger, @trainedPredictor};     
                                 % Use:
